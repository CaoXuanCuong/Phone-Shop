...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="body-header">
                <div class="tabs">
                    ...
                    <div class="tab" runat="server">
                        ...
                        <div id="infoCMT" style="display: none;" class="info-cmt" runat="server">
                            <textarea id="Txt_danhgia" style="overflow: hidden; font-size: 16px" cols="20" rows="2" runat="server" onkeydown="Trig()" type="Sản phẩm ngon vl" class="txtComment" placeholder="Comment..."></textarea>
    ...
    <script>
        //Hàm xử lý lấy danh sách bình luận
        function napDanhsachDanhgia(idSP) {
            var d2;
            ...
            xhttp.onreadystatechange = function () {
                ...
                for (var i = 0; i < x.length; i++) {
                    ...
                    html += "<span id=\"Username\" class=\"username-cmt\">" + x[i].childNodes[1].textContent + "</span>";
                    html += "<span id=\"Comments\">" + x[i].childNodes[3].textContent + "</span>";
                    d2 = String(x[i].childNodes[5].textContent);
                    html += "<span  id=\"Label1\" class=\"time-cmt\">" + "Đã bình luận ngày " + dinhdang(d2) + "</span>";
            ...
            xhttp.open("GET", "Chitietsanpham.aspx?act=lay&sID_SanPham=" + idSP, true);
            xhttp.send();
        ...
        function themCmt(idSP) {
            ...
            if (binhluan[0].value == "") {
                ...
                xhttp.open("POST", "Chitietsanpham.aspx?act=them&sID_SanPham=" + idSP + "&cmt=" + binhluan[0].value, true);
                xhttp.send();
            }
        }
