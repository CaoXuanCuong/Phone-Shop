<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="QuanLyHD.aspx.cs" Inherits="BTL_Web.QuanLyHD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:700px; background:white;" class="page-inner">
    ...
    <div style="padding-top: 20px; overflow-x: auto; width: 1230px">
        <table>
            <tr>
                <td colspan="4">
